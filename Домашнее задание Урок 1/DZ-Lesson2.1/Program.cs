...
Console.Write("Введите количество панелий: ");
countSquare = int.Parse(Console.ReadLine());

Console.Write("Введите размер  А: ");
sizeA = int.Parse(Console.ReadLine());

Console.Write("Введите кразмер  Б: ");
sizeB = int.Parse(Console.ReadLine());


int commonSquar = sizeA * sizeB * 2;
int countSulfide = commonSquar * countSquare;

if (countSquare <= 100 && sizeA<= 100 && sizeB <= 100) 
{
	Console.WriteLine(countSulfide);
}
else
{
	Console.WriteLine("Введены не коректно данные!");
}
